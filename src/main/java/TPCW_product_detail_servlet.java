...
public class TPCW_product_detail_servlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
      ...
      out.print("<H2> Title: "+mybook.getTitle() +"</H2>\n");
      out.print("<P>Author: "+mybook.getAuthor().getFname() +" "+
                mybook.getAuthor().getLname() + "<BR>\n");
      out.print("Subject: " + mybook.getSubject() + "\n");
      out.print("<P><IMG SRC=/../images/"+mybook.getImage() + 
	    " ALIGN=\"RIGHT\" BORDER=\"0\" WIDTH=\"200\" HEIGHT=\"200\">\n");
      out.print("Decription: <I>"+ mybook.getDesc() + "</I></P>\n");
      out.print("<BLOCKQUOTE><P><B>Suggested Retail: " + 
		  mybook.getSrp() + "</B>\n");
      out.print("<BR><B>Our Price:</B>\n");
      out.print("<FONT COLOR=\"#dd0000\"> <B> " + mybook.getCost() + 
		  "</B></FONT><BR>\n");
      out.print("<B>You Save:</B><FONT COLOR=\"#dd0000\"> $" 
		  + (mybook.getSrp() - mybook.getCost()) + "</B></FONT></P>\n");
      out.print("</BLOCKQUOTE><DL><DT><FONT SIZE=\"2\">\n");
      out.print("Backing: " + mybook.getBacking() + ", " + mybook.getPage() + 
		  " pages<BR>\n");
      out.print("Published by " + mybook.getPublisher() +"<BR>\n");
      out.print("Publication date: " + mybook.getPubDate() +"<BR>\n");
      out.print("Avail date: " + mybook.getAvail() + "<BR>\n");
      out.print("Dimensions (in inches): " + mybook.getDimensions() + "<BR>\n");
      out.print("ISBN: " + mybook.getIsbn() +"</FONT></DT></DL><P>\n");
