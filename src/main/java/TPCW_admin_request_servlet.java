...
public class TPCW_admin_request_servlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    // Set the content type of this servlet's result.
      ...
      out.print("<H2 ALIGN=\"center\">Title:" + book.getTitle() + "</H2>\n");
      out.print("<P ALIGN=\"LEFT\">Author: " + book.getAuthor().getFname() + " "  
		+ book.getAuthor().getLname() + "<BR></P>\n");
      out.print("<IMG SRC=\"/../images/" 
		+ book.getImage() + "\" ALIGN=\"RIGHT\" BORDER=\"0\" " + 
		"WIDTH=\"200\" HEIGHT=\"200\" >\n");
      out.print("<IMG SRC=\"/../images/" + book.getThumbnail() +  
      ...
      out.print("<TR><TD><B>Suggested Retail:</B></TD><TD><B>$ " + book.getSrp()
                + "</B></TD></TR>\n");
      out.print("<TR><TD><B>Our Current Price: </B></TD>" +
		"<TD><FONT COLOR=\"#dd0000\"><B>$ " + book.getCost() +  
		"</B></FONT></TD></TR>\n");
