...
public class TPCW_shopping_cart_interaction extends HttpServlet {
	...
	for(CartLine line : cart.getLines()){
	    ...
	    out.print("<TD VALIGN=\"top\">Title:<I>" + line.getBook().getTitle() +
		      "</I> - Backing: " + line.getBook().getBacking() + "<BR>\n");
	    out.print("SRP. $" + line.getBook().getSrp() + "</B>\n");
	    out.print("<FONT COLOR=\"#aa0000\"><B>Your Price: $" + 
		      line.getBook().getCost() + "</B></FONT></TD></TR>\n");
	}

	out.print("</TABLE><B><I>Subtotal price: "  + cart.subTotal(0) + 
		  "</I></B>\n");
