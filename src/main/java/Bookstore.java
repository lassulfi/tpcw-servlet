...
public class Bookstore implements Serializable {
	...
	private Address createAddress(String street1, String street2, String city, String state, String zip,
			Country country) {
		int id = addressById.size();
		Address address = new Address(id, street1, street2, city, state, zip, country);
	...
	public Customer createCustomer(String fname, String lname, String street1, String street2, String city,
			String state, String zip, String countryName, String phone, String email, double discount, Date birthdate,
			String data, long now) {
	...
	private Customer createCustomer(String fname, String lname, Address address, String phone, String email, Date since,
	...
	private Author createAuthor(String fname, String mname, String lname, Date birthdate, String bio) {
	...
	private Book createBook(String title, Date pubDate, String publisher, String subject, String desc, String thumbnail,
	...
	public boolean populate(long seed, long now, int items, int customers, int addresses, int authors, int orders) {
		if (populated) {
			return false;
		}
	...
	private void populateAuthorTable(int number, Random rand) {
		...
		for (int i = 0; i < number; i++) {
			...
			createAuthor(TPCW_Util.getRandomString(rand, 3, 20), TPCW_Util.getRandomString(rand, 1, 20),
					TPCW_Util.getRandomString(rand, 1, 20), TPCW_Util.getRandomBirthdate(rand),
	...
	private void populateBooks(int number, Random rand) {
		...
		for (int i = 0; i < number; i++) {
			...
			createBook(TPCW_Util.getRandomString(rand, 14, 60), pubdate, TPCW_Util.getRandomString(rand, 14, 60),
					SUBJECTS[rand.nextInt(SUBJECTS.length)], TPCW_Util.getRandomString(rand, 100, 500),
					"img" + i % 100 + "/thumb_" + i + ".gif", "img" + i % 100 + "/image_" + i + ".gif", srp, cost,
					...
					author, TPCW_Util.getRandomInt(rand, 10, 30));
		}
