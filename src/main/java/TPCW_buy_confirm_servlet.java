...
public class TPCW_buy_confirm_servlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    // Set the content type of this servlet's result.
	  ...
	  order = TPCW_Database.doBuyConfirm(SHOPPING_ID, C_ID,CC_TYPE, 
					      CC_NUMBER, CC_NAME, 
					      new java.sql.Date(CC_EXPIRY.getTime()), 
					      SHIPPING, STREET_1, STREET_2,
					      CITY, STATE, ZIP, COUNTRY);
      }
      else order = TPCW_Database.doBuyConfirm(SHOPPING_ID, C_ID, 
	  ...
	  out.print("<TR><TD VALIGN=\"TOP\">" + line.getQty()+ "</TD>\n");
	  out.print("<TD VALIGN=\"TOP\">Title:<I>" + line.getBook().getTitle() 
		    + "</I> - Backing: " +line.getBook().getBacking() 
		    + "<BR>SRP. $" + line.getBook().getSrp() + 
		    "<FONT COLOR=\"#aa0000\"><B>Your Price: $" + 
		    line.getBook().getCost() + "</FONT> </TD></TR>\n");
      }
      ...
      out.print("<TD> <H4>$" + order.getSubtotal() +"</H4></TD></TR>");
      out.print("<TR><TD><H4>Tax (8.25%):</H4></TD>\n");
      out.print("<TD><H4>$" + order.getTax() + "</H4></TD></TR>\n");
      out.print("<TR><TD><H4>Shipping &amp; Handling:</H4></TD>\n");
      out.print("<TD><H4>$"+ (order.getTotal() - order.getSubtotal() - order.getTax()) + "</H4></TD></TR>\n");
      out.print("<TR><TD> <H4>Total:</H4></TD>\n");
      out.print("<TD><H4>$" + order.getTotal() + "</H4></TD></TR></TABLE>\n");
      out.print("<P><BR></P><H2>Order Number: " + order.getId() + "</H2>\n");
