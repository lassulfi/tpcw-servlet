  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    // Set the content type of this servlet's result.
	 ...
	 || I_NEW_THUMBNAIL.length() == 0) {
	  ...
	  out.print("<H2>Title: " + book.getTitle() + "</H2>\n");
	  out.print("<P>Author: " + book.getAuthor().getFname() + " " +
	            book.getAuthor().getLname() + "</P>\n");
	  ...
	  out.print("<IMG SRC=\"/../images/" + I_NEW_THUMBNAIL + 
		    ...
		    +" HEIGHT=\"150\">\n");
	  out.print("Description: " + book.getDesc() + "</P>\n");
	  out.print("<BLOCKQUOTE><P><B>Suggested Retail: $" + book.getSrp() +
		    "</B><BR><B>Our Price: </B><FONT COLOR=\"#DD0000\"><B>" +
		    I_NEW_COSTstr+"</B></FONT><BR><B>You Save: </B><FONT " + 
		    "COLOR=\"#DD0000\"><B>" + 
		    Double.toString((book.getSrp() - 
				     (Double.valueOf(I_NEW_COSTstr)).doubleValue())) + "</B></FONT></P></BLOCKQUOTE> ");
	  out.print("<P><FONT SIZE=\"2\">" + book.getBacking() +", " + 
		    book.getPage() +
		    " pages<BR>\n");
	  out.print("Published by " + book.getPublisher() + "<BR>\n");
	  out.print("Publication date: " + book.getPubDate() + "<BR>\n");
	  out.print("Dimensions (in inches): " +book.getDimensions()+ "<BR>\n");
